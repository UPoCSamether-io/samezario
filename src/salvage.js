 ...
 *
 * 先頭の 0.40（初期可読率 67%）と末尾の 0 は動かさない。あいだを刻む数だけを増やしてある。
 * 4段階だったころは最初の変化が 1,500XP 到達で、1プレイの到達質量 1000〜2000 に届かず
 * 初回プレイでは1文字も増えなかった。7段階にすると最初の変化が 700XP になり、
 * 1プレイ目の結果で必ず泥が落ちる。1段階あたりの新出は +14〜38字（seed 20260819 実測）で、
 * どの幕・どの段階でも0字にならない。
 */
export const STAGE_RATIO = [0.40, 0.32, 0.25, 0.185, 0.12, 0.06, 0];
