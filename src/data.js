...
export const MAPS = [
  {
    ...
    unlocked: true,
    label: { x: 44, y: 67 },
    path: 'M352 545l33 7,118 45,108 12,15 0,13 -7,15 2,22 29,9 28,40 15,0 18,-27 9,-410 -11,53 -136,9 -9z',
    color: '#c0544c',
    size: 4000,
    water: '#2a7b7c',
  ...
  },
  {
    ...
    unlocked: false,
    label: { x: 35, y: 74 },
    path: 'M56 530l292 15,350 158,-33 81,-8 81,-13 61,-16 3,-42 -18,-107 -2,-11 -7,-20 -37,-157 -50,-14 -7,-43 -26,-69 -11,-15 -11,-52 -59,-3 -108,-24 -28,-15 -2,-5 -9z',
    color: '#4e8a5f',
    size: 5200,
    water: '#2f7f86',
    blurb: '広い河川敷と速い流れ。マップ最長、そして最速。',
    lore:
  ...
  },
  {
    ...
    unlocked: false,
    label: { x: 21, y: 45 },
    path: 'M205 238l15 4,2 44,11 5,1 21,19 12,2 15,-8 15,2 5,24 8,9 -26,20 0,28 22,-2 35,13 2,6 13,38 2,9 9,4 81,-13 42,-15 4,-22 -6,-292 -15,72 -167,13 -4,5 -16,15 -8,9 -40,-5 -22,1 -18,8 -4,20 4,4 -13,5 -2z',
    color: '#d8a72c',
    size: 4400,
    water: '#2b7280',
  ...
  },
  {
    ...
    size: 4800,
    water: '#285868',
    blurb: '武者小路実篤の庭園と学生街。仙川のカフェと文化が息づく海。',
    lore:
      '調布市東部に位置するつつじヶ丘・仙川エリアは、白百合女子大学や桐朋学園が位置する学園都市。' +
      '武者小路実篤が晩年を過ごした実篤公園や記念館があり、文化的な香りが漂う。',
    spot: {
      ...
      desc: '作家・武者小路実篤が晩年の20年間を過ごした邸宅と庭園。武蔵野の湧水と豊かな自然が今も残る。',
      hashes: [], threshold: 14,
    },
  },
];
...
export const TIPS = [
  ...
  '実篤公園は武者小路実篤が晩年を過ごした邸宅跡。園内には湧水池があり、四季折々の草花が彩る。',
  'つつじヶ丘・仙川エリアは桐朋学園や白百合女子大を擁する学生街。劇場やカフェが並ぶおしゃれな街並みが広がる。',
];
